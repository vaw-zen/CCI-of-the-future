...
| CRO sprint | `landingPageScorecard`, `funnelDiagnostics`, `Executive summary`, `Attribution review leads` |
...
3. The problem is specific enough to turn into a hypothesis next week.
