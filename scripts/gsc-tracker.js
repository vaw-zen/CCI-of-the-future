...
async function trackKeywords() {
  const tracker = new GSCTracker('./gsc-credentials.json', 'https://cciservices.online');
  ...
  const updatedCSV = await tracker.updateKeywordCSV('./seo-keywords.csv', performance);
